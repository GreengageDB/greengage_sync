...
partitioned_table_reloptions(Datum reloptions, bool validate)
{
	 ...
	 * inheritance and hierarchy wide ALTER TABLE SET().  Upstream restricts
	 * partitioned tables to RELOPT_KIND_PARTITIONED (autovacuum_enabled,
	 * autovacuum_analyze_threshold and autovacuum_analyze_scale_factor); GPDB
	 * deliberately accepts the full heap option set instead, which is a
	 * superset of those.
	 */
