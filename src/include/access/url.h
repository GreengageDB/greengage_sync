...
/* exported functions */
extern URL_FILE *url_fopen(char *url, bool forwrite, extvar_t *ev, CopyFromState pstate, ExternalSelectDesc desc);
...
extern size_t url_fwrite(void *ptr, size_t size, URL_FILE *file, CopyFromState pstate);
extern void url_fflush(URL_FILE *file, CopyFromState pstate);

/* prototypes for functions in url_execute.c */
extern char *make_command(const char *cmd, extvar_t *ev);

/* implementation-specific functions. */
extern URL_FILE *url_curl_fopen(char *url, bool forwrite, extvar_t *ev, CopyFromState pstate);
...
extern size_t url_curl_fwrite(void *ptr, size_t size, URL_FILE *file, CopyFromState pstate);
extern void url_curl_fflush(URL_FILE *file, CopyFromState pstate);
...
extern URL_FILE *url_execute_fopen(char *url, bool forwrite, extvar_t *ev, CopyFromState pstate);
...
extern size_t url_execute_fwrite(void *ptr, size_t size, URL_FILE *file, CopyFromState pstate);

extern URL_FILE *url_custom_fopen(char *url, bool forwrite, extvar_t *ev, CopyFromState pstate, ExternalSelectDesc desc);
...
extern size_t url_custom_fwrite(void *ptr, size_t size, URL_FILE *file, CopyFromState pstate);
