...
PG_KEYWORD("ao_aux_only", AO_AUX_ONLY, TYPE_FUNC_NAME_KEYWORD, AS_LABEL) /* GPDB */
...
PG_KEYWORD("cpu_hard_quota_limit", CPU_HARD_QUOTA_LIMIT, UNRESERVED_KEYWORD, BARE_LABEL)		/* GPDB */
PG_KEYWORD("cpu_soft_priority", CPU_SOFT_PRIORITY, UNRESERVED_KEYWORD, BARE_LABEL)		/* GPDB */
