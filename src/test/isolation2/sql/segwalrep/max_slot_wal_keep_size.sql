...
-- replication slots.  That makes it necessary to set max_wal_size to
-- a low value, the lowest the server accepts, that is size of 2 WAL
-- files.  Other GUCs are needed to make the test run faster.
0U: ALTER SYSTEM SET max_slot_wal_keep_size TO 128;
0U: ALTER SYSTEM SET max_wal_size TO 128;
